...
class FBConnect
{
	...
	public:
		...
		// Facebook SDK 4+
		virtual void Login( const char *permissions[], int numPermissions ) const = 0;
		// Facebook SDK 3.19
		//virtual bool IsAccessDenied() const = 0;
		//virtual void Login( const char *appId, const char *permissions[b], int numPermissions ) const = 0;
